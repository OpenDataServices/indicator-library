...
project = 'Collective Impact Indicator Data Specification'
copyright = '2018 Global Coffee Platform'
...
man_pages = [
    (master_doc, 'sphinx', 'Collective Impact Indicator Data Specification',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Global Coffee Platform', 'Collective Impact Indicator Data Specification',
     author, 'Global Coffee Platform', 'Demonstrating Collective Impact in the Global Coffee Sector.',
     'Miscellaneous'),
]
